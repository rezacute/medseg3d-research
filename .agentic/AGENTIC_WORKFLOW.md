# AGENTIC_WORKFLOW.md — Research Agent Workflow
...
| Task | Skill |
|------|-------|
| QRC experiments, benchmarks | `research-qrc/SKILL.md` |
| MedSeg3D, nnU-Net, AMOS22 | `research-medseg/SKILL.md` |
| Running code, git, environment | `code-execution/SKILL.md` |
| Paper structure, figures, citations | `paper-writing/SKILL.md` |
