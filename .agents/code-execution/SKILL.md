---
name: code-execution
description: Execute research code, manage environments, git workflow, and GPU checking for the medseg3d-research project.
metadata: {"openclaw": {"requires": {"bins": ["python", "git", "nvidia-smi"]}}}
---
