...
class DataConfig:
    ...
    Attributes:
        dataset: Dataset name (e.g., "synthetic", "acn_data")
        resolution: Time resolution (e.g., "1h", "15min")
        window_size: Input window size in timesteps
        forecast_horizon: Forecast horizon in timesteps
